...
class Console(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.consoleSaveBtn = ctk.CTkButton(self.consoleControls, corner_radius=10, text="Save")
        ...
        self.consoleClearBtn = ctk.CTkButton(self.consoleControls, corner_radius=10, text="Clear console")
